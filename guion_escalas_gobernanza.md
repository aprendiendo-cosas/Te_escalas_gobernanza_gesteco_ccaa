...
La incorporación de este acto docente durante el presente curso al contenido de la asignatura responde a una solicitud explícita de los estudiantes del curso 2023-2024. En la [sesión inicial](https://rawcdn.githack.com/aprendiendo-cosas/Te_introduccion_gesteco_ccaa/2023_2024/guion_introduccion_gesteco.html) consensuamos una definición de "gestión de ecosistemas" y esbozamos algunos conocimientos necesarios para aprender sobre la materia. Entre estos conocimientos requeridos estaban los siguientes:
...
Ya en este primer nivel de escala observamos algo que será muy común a lo largo de todo el camino: los instrumentos de gobernanza diseñados para incidir a una escala de terminada no siempre disponen de los recursos necesarios para ello. Por ejemplo, los Ayuntamientos tienen un papel fundamental en la gestión de los recursos a escala local. Sin embargo, disponen de poca capacidad económica para ello (al menos en nuestro país). Esto puede deberse a que ocurren procesos de "economía de escala". Este concepto se refiere a que una institución (o un sistema) más grande tiene unos costes de mantenimiento *per capita* menores que otra más pequeña. Eso hace que los recursos económicos para gestionar los ecosistemas no estén en los niveles jerárquicos inferiores de la gobernanza. O dicho de otra forma, las entidades locales no tienen a su alcance recursos económicos para gestionar su territorio. Dichos recursos se desplazan a otras entidades superiores debido a este fenómeno. Este concepto se describe con detalle en un libro llamado "Scale", escrito por [Geoffrey West](https://en.wikipedia.org/wiki/Geoffrey_West). 

Conforme ampliamos el foco (o conforme vemos más de lejos la escala local), observamos que las variables con las que describimos los ecosistemas y la naturaleza de las instituciones de gobernanza, cambian. En el caso de las variables "naturales" ocurre un proceso de integración y trascendencia para llegar al siguiente nivel. La integración implica la incorporación de elementos de los niveles anteriores. Por ejemplo, el concepto de producción primaria, que es "visible" desde una escala local, resulta de la incorporación de trillones de procesos moleculares que funcionan a escalas mucho más pequeñas. El concepto de trascendencia alude a que una variable que se usa para describir el funcionamiento de un sistema a una escala superior aporta un nivel de comprensión o de conocimiento mayor que el alcanzado en el nivel del que parte. Siguiendo con el concepto de producción primaria, esta nueva idea (presente en niveles de escala superiores) nos aporta un nivel de comprensión del sistema superior al que aporta el conocimiento a escala molecular en la fotosíntesis, por ejemplo. 

El siguiente nivel que hemos considerado implica poner el foco en una superficiie de entre 1000 y 10000 Has. Se trata de un límite arbitrario. Los niveles de escala son continuos en realidad. Los hacemos discretos para entenderlos mejor. A esta escala podemos describir la naturaleza usando los conceptos de biomasa, caudales de los ríos, cantidad de nieve disponible en las montañas, etc. En el ámbito de las instituciones, es el área de trabajo de las comarcas, gestión agraria, las áreas metropolitanas, etc. Este nivel es importante para la gestión de ecosistemas, aunque al igual que en el caso anterior, observamos que hay pocos recursos dedicados a este aspecto. Tendremos que esperar aún algo para encontrar instituciones dedicadas de manera primaria a gestionar los ecosistemas. 

Cuando observamos un área del orden del millón de hectáreas, ya no se ven de forma tan evidente los elementos biológicos. La geomorfología, el concepto de paisaje y el clima, empiezan a ser los elementos descriptores principales de la realidad natural. A esta escala y en el ámbito de la gobernanza, hemos creado las Diputaciones provinciales. Su objetivo principal es reducir los efectos negativos que tienen las economías de escala en los municipios pequeños. Tienen pocas responsabilidades de gestión de ecosistemas. 

Buena parte de la capacidad de gestionar los ecosistemas se ha "cedido" o delegado al siguiente nivel de escala. Es lo que en España se denomina Comunidad Autónoma. Esto nos lleva, en el caso de Andalucía, a poner el foco en territorios del orden de diez millones de hectáreas de superficie. Las comunidades autónomas tienen transferidas la mayor parte de las competencias de gestión de los recursos naturales en nuestro país. Ellas son las responsables de gestionar los ecosistemas a escala local. Buena parte de las competencias que no se pueden implementar a escala local por falta de recursos, son "delegadas" a escala de comunidad autónoma. Otra institución similar en cuanto a territorio gestionado pero muy sectorializada son las Confederaciones hidrográficas. En la parte natural del sistema, observamos a esta escala cuestiones abióticas como el clima o la hidrología. 

A una escala superior encontramos variables biofísicas climáticas como elementos descriptores clave de la realidad natural. En el ámbito de la gobernanza son los estados los que tienen más responsabilidades a esta escala. En nuestro país esta institución ha experimentado una cesión de competencias muy intensa hacia las comunidades autónomas desde la llegada de la democracia (1978). Estos procesos descentralizadores han intentado reducir el impacto negativo de las economías de escala que describimos anteriormente. 

El siguiente nivel de escala tiene mucha importancia en el ámbito de la gobernanza en Europa pero es casi inexistente en otras regiones. En nuestro caso los estados están integrados en una entidad superior denominada Unión Europea (UE). Esta institución tiene un papel muy importante en el diseño e implementación de medidas de gestión de ecosistemas. Podríamos decir que la UE inspira las políticas de gestión de la naturaleza en los estados miembros. Estas directrices son incorporadas por los estados en su legislación y luego transferidas a las comunidades autónomas, que son las que las implementan en el territorio. En el ámbito más natural, es el clima el elemento más destacable a esta escala. 
